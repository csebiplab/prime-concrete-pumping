  ...
  return (
    <div className="mt-[120px]">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-6 items-center gap-x-16 ">
          <div className="py-6 lg:py-16 px-6 lg:pl-[71px] lg:pr-2 lg:col-span-3 bg-primary text-white">
            <div className="">
          ...
          <div className="rounded-lg p-5 lg:col-span-3 lg:p-12 items-center">
            ...
            <form action="#" className="space-y-4 ">
              ...
              <div className="flex justify-center md:justify-start">
                <button
                  type="submit"
                  className=" w-full rounded-md bg-primary px-10 py-4 lg:px-20  font-semibold  sm:w-auto items-center flex lg:mt-13 mt-8"
                >
