...
import RemoveCategoryBtnComponent from "../Buttons/RemoveCategoryBtnComponent";


export default function CategoryList({ allCategorylist }) {
  return (
    <div>
      <div className="px-5">
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2">
                      {" "}
                      <Link
                        href={`/dashboard/blogs/categories/editCategory/${item?._id}`}
                      >
                        <HiPencilAlt size={24} />
                      </Link>
                      <RemoveCategoryBtnComponent id={item._id} />
                    </div>
                  </td>
                </tr>
              ))}
