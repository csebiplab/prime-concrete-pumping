        ...
        <div className='full__section_r_p pl-3 md:pl-0 padding__top'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[24px]'>
                ...
                <div className='md:col-span-1'>
                    ...
                    <h4 className='text-[25px] md:text-[26px] lg:text-[28px] xl:text-[30px] 2xl:text-[31px] 3xl:text-[33px] 4xl:text-[35px] 5xl:text-[36px] text-primary-50 font-bold leading-normal text-center md:text-left '>How Much Concrete Pump <span className='text-primary'>Cost?</span> 
                    </h4>
