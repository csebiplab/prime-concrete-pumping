        ...
        <div className='container padding__top'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[24px]'>
                ...
                <div className='md:col-span-1'>
                    ...
                    <h2 className='text-[25px] md:text-[26px] lg:text-[28px] xl:text-[30px] 2xl:text-[31px] 3xl:text-[33px] 4xl:text-[35px] 5xl:text-[36px] text-primary-50 font-bold leading-normal text-center md:text-left '>We Lead  <br/> <span className='text-primary'> the Barrie Concrete Pumping Business</span> 
                    </h2>
